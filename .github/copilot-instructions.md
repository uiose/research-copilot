...
| **Learning Coach** | 概念引导 + 错漏诊断 + 资源推荐 + 任务逐步陪跑 | 只读 | 不懂某个概念、想要学习资源、需要有人引导思考、做任务时逐步引导、想检查自己的理解有没有错漏 | 生成计划、改代码、跑命令 |
...
**@Learning Coach** — 回答纠错与概念缺口诊断
```
这是我对 grounding 的理解，帮我看看哪里有错漏，并告诉我缺了哪些核心概念
```
```
我这样解释 planner 和 memory 的区别对吗？如果不对，请指出问题并推荐补课资源
```
```
下面是我的回答，请你像导师一样指出错误、遗漏和概念混淆
```
